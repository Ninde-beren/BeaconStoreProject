...
package imie.angers.fr.beaconstoreproject.slidingtabscolors;
...
import imie.angers.fr.beaconstoreproject.view.SlidingTabLayout;
...
public class SlidingTabsColorsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabs.add(new SamplePagerItem(
                getString(R.string.hello_world), // Title
        ...
        mTabs.add(new SamplePagerItem(
                getString(R.string.more_infos), // Title
                Color.YELLOW, // Indicator color
                Color.GRAY // Divider color
        ));

        mTabs.add(new SamplePagerItem(
                getString(R.string.done), // Title
